...
function getMockStats() {
    ...
    for (let i = 11; i >= 0; i--) {
        ...
        monthlyStats[key] = Math.floor(Math.random() * 8) + 1; // 1-8 film visti
    }
    // Mock: ultimi 5 anni
    const yearlyStats = {};
                            ...
                            <div class="carousel-container">
                                <div class="carousel">
                                    <div class="carousel-chart">
                                        <div class="carousel-title">Film visti per Mese</div>
                                    ...
                                    <div class="carousel-chart">
                                        <div class="carousel-title">Film visti per Anno</div>
                                        ${createCartesianChart(
                                            stats.yearlyStats,
                                            true
                                        )}
